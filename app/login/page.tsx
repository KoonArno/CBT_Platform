...
import { Loader2, Stethoscope, LogIn, Eye, EyeOff } from "lucide-react";
...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState("supervisor@thera.app");
        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-sm sm:p-8">
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Sign in to continue your CTS-R supervision workflow.
            </p>
          </div>
          ...
          <div className="mt-5 rounded-md border border-dashed border-border bg-accent/40 px-3 py-2 text-[11px] text-muted-foreground">
            Demo mode · ระบบยังไม่เชื่อมฐานข้อมูลจริง กด Sign in ได้เลย
          </div>
